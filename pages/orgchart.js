...
(OrgChart._defaultConfig = function (t) {
        ...
        this.manager.read(
          ...
          function (n) {
            if (
              ...
              var o = { defs: "" };
              OrgChart.events.publish("renderdefs", [a, o]);
              var l = a.ui.defs(o.defs),
                s = a.getScale(n.viewBox);
              l += a.ui.pointer(a.config, e, s);
              var h = a.getViewBox(),
                d = n.viewBox;
              o = { content: l, res: n };
              OrgChart.events.publish("prerender", [a, o]), (l = o.content);
              for (var c = 0; c < n.visibleNodeIds.length; c++) {
                var g = n.nodes[n.visibleNodeIds[c]],
                  p = a._get(g.id);
              ...
              for (c = 0; c < n.visibleNodeIds.length; c++) {
                g = n.nodes[n.visibleNodeIds[c]];
                OrgChart.RENDER_LINKS_BEFORE_NODES ||
                  (l += a.ui.link(
                    g,
                    a,
                  ...
                  (l += a.ui.expandCollapseBtn(a, g, a._layoutConfigs, e, s));
              }
              o = { content: l, res: n };
              if (
                (OrgChart.events.publish("render", [a, o]),
                (l = o.content),
                (n = o.res),
                ...
                (e !== OrgChart.action.centerNode &&
                  ...
                  (d = h),
                  e === OrgChart.action.init && null != h && (d = h),
                  (a.response = n);
                x = a.ui.svg(a.width(), a.height(), d, a.config, l);
                if (a._initialized) {
                  var u = a.getSvg(),
                    f = u.parentNode;
                  f.removeChild(u),
                    f.insertAdjacentHTML("afterbegin", x),
                  ...
                  (a.element.innerHTML =
                    a.ui.css() + x + a.ui.menuButton(a.config)),
                ...
                e === OrgChart.action.centerNode
                  ...
                  : !h ||
                    !a.response ||
                    (h[0] == a.response.viewBox[0] &&
                      h[1] == a.response.viewBox[1] &&
                      h[2] == a.response.viewBox[2] &&
                      h[3] == a.response.viewBox[3]) ||
                    (e !== OrgChart.action.insert &&
                      e !== OrgChart.action.expand &&
                      e !== OrgChart.action.collapse &&
                      e !== OrgChart.action.update &&
                ...
                var b = n.boundary,
                  O = b.maxX - b.minX,
                  v = b.maxY - b.minY,
                  x = a.ui.svg(O, v, [b.minX, b.minY, O, v], a.config, l, s);
                i(x);
              }
            }
          },
      ...
      this.config.enableTouch || OrgChart.isMobile()
        ...
        : (this._addEvent(t, "mousedown", this._globalMouseDownHandler),
          ...
          (this.config.mouseScrool != OrgChart.action.zoom &&
            this.config.mouseScrool != OrgChart.action.ctrlZoom) ||
  ...
  (OrgChart.editUI.prototype.content = function (t, e, r, i, a) {
    ...
    if (
      ...
      A.classList.add(u.templateName),
          ...
          if (Array.isArray(i)) {
            ...
            for (var a = 0; a < i.length; a++) {
              ...
              !OrgChart.isNEU(s.id) &&
                ...
                (n = s.id),
                OrgChart.isNEU(s.value) || E.push(`${o.label}: ${s.value}`),
                (t += s.html);
            }
            t += "</div>";
          } else {
            ...
            !OrgChart.isNEU(s.id) &&
              ...
              OrgChart.isNEU(s.value) &&
              (n = s.id),
              OrgChart.isNEU(s.value) || E.push(`${i.label}: ${s.value}`),
              (t += s.html);
          }
        }
        return t;
      ...
      if (
        ...
        for (
          var m = 0,
            ...
            O = 2 * Math.PI * b,
            v = O / C - (2 * a.nodeCircleMenuButton.radius + 2);
          v < 0;
        ...
        for (var x in ((p = document.createElementNS(
          "http://www.w3.org/2000/svg",
          "g"
        ...
        u.menu)) {
          ...
          if ((A.setAttribute("pointer-events", "none"), A)) {
            ...
            A.setAttribute("x", -E / 2), A.setAttribute("y", -N / 2);
          }
          var L = (m * Math.PI) / (C / 2);
          m++;
          var M = Math.cos(L) * b,
  ...
  (OrgChart.prototype._pagesA100 = function (t, e, r) {
    ...
    for (
      var g = d.w * (100 / r), p = d.h * (100 / r), u = o, f = l, m = [];
      u < s + o;
    ...
    if (n.draggable) {
      ...
      var O = function (t, e) {
          ...
          if (p) {
            ...
            if (s.left || s.right || s.up || s.down) {
              ...
              if (null != d) {
                ...
                for (
                  var A = o.getNode(d), E = OrgChart.getStParentNodes(A), N = 0;
                  N < E.length;
                  N++
                ) {
                  var L = o.getNodeElement(E[N].id);
        ...
        x = function (e) {
          ...
          OrgChart.events.publish("drop", [
            o.nodeCircleMenuUI,
            { from: s.id, to: i.id, menuItem: n, menuItemName: a },
          ]),
            O(d, c),
            g.removeChild(u),
            (o._gragStartedId = null);
      ...
      var m = function (t, e) {
          ...
          if (d) {
            ...
            if (C.left || C.right || C.up || C.down) {
              ...
              s.moveStart(C, function (t) {
                (c[4] = O + t.x),
                  (c[5] = v + t.y),
                  (d.x = x - t.xWithoutScale),
                  (d.y = y - t.yWithoutScale),
              ...
              if (
                ...
                !1 === OrgChart.events.publish("drag", [s, k, e]) && b(),
                  (t._dragEventFired = !0);
              f.setAttribute("transform", "matrix(" + c.toString() + ")");
            }
          }
        ...
        b = function (e) {
          if (
            ...
            return (
              t._dragEventFired &&
                OrgChart.events.publish("drop", [s, n.id, void 0, f]),
              h.removeChild(f),
              void (s._gragStartedId = null)
            );
          var i = s.getNode(o);
          if (!1 === OrgChart.events.publish("drop", [s, n.id, i.id, f]))
  ...
  (OrgChart.searchUI.prototype.init = function (t) {
    ...
    this.obj.element.insertBefore(l, h),
      OrgChart.input.init(l),
    ...
    if (t) {
      if (t.hasAttribute("data-search-item-id")) {
        ...
        if (this.input.value != OrgChart.SEARCH_HELP_SYMBOL)
          0 != OrgChart.events.publish("searchclick", [this.obj, e]) &&
            this.obj.center(e);
        else
          (this.input.value = e + " "),
  ...
  (OrgChart.searchUI.prototype._initSearchFields = function () {
    if (null == this.obj.config.searchFields) {
      ...
      for (var t = 0; t < this.obj.response.allFields.length; t++) {
        ...
        "tags" == e ||
          OrgChart._fieldIsImg(this.obj.config, e) ||
          this._searchFields.push(e);
      }
    ...
    if (null == this.obj.config.searchFieldsAbbreviation) {
      ...
      this._searchFieldsAbbreviation = this.obj.config.searchFieldsAbbreviation;
  }),
  ...
  (OrgChart.searchUI.prototype._search = function () {
      ...
      t = `<table border="0" cellspacing="0" cellpadding="0">\n                        <tbody>\n                            ${(function () {
        for (
          ...
          var a = e.lastSearch[i],
            n = "";
          if (r) {
            var o = e.obj._get(a.id);
            "function" == typeof r
              ? (n = r(e.obj, e.obj.getNode(a.id), o))
              : o[r] && (n = o[r]);
          }
          var l = "",
            s = "";
          e.obj.config.searchDisplayField == a.__searchField
            ? (l = a.__searchMarks)
            : e.obj.config.searchDisplayField
            ? ((l = a[e.obj.config.searchDisplayField]),
              OrgChart.isNEU(l) && (l = ""),
              (s = a.__searchMarks))
            : (l = a.__searchMarks),
            (t += OrgChart.searchUI.createItem(n, a.id, l, s));
        }
        return t;
      })()}  \n                        </tbody>\n                    </table>`;
    }
    ...
    for (
      var i = this.obj.element.querySelectorAll("[data-search-item-id]"), a = 0;
      a < i.length;
      a++
    )
  ...
  (OrgChart.searchUI.prototype.helpView = function () {
    ...
    for (var e in this._searchFieldsAbbreviation)
      t += `<tr data-search-item-id="${e}" style="height: 50px;"><td class="boc-search-image-td" style="text-align: center;">${e}</td><td class="boc-search-text-td">${this._searchFieldsAbbreviation[e]}</td></tr>`;
    return (t += "</table>");
  }),
  ...
  (OrgChart.searchUI.prototype.hide = function () {
    this._searchAfterEnterPress &&
      ((this._searchAfterEnterPress = !1), this.obj.draw()),
      (this.lastSearch = []),
  ...
  (OrgChart.manager._initNode = function (t, e, r, i, a, n, o) {
    ...
    var b = { node: t };
    OrgChart.events.publish("node-initialized", [o, b]),
  ...
  (OrgChart.manager._iterate = function (t, e, r, i, a, n, o, l, s, h, d, c) {
    ...
    for (b = 0; b < e.children.length; b++)
      OrgChart.manager._iterate(t, e.children[b], r, i, a, n, o, l, s, h, d, c);
  }),
  ...
  (OrgChart.manager._createNodes = function (t) {
    ...
    if (i == OrgChart.action.init && e.expand && e.expand.nodes && null == o)
      ...
      for (var v = l[a.id]; v; ) {
        if (
          (m.push(v.id),
          a.options.parentState === OrgChart.COLLAPSE_PARENT_NEIGHBORS && v)
        )
          for (d = 0; d < v.childrenIds.length; d++) {
            (D = l[v.childrenIds[d]]).collapsed = !0;
          }
      ...
      if (a.options.childrenState === OrgChart.COLLAPSE_SUB_CHILDRENS)
        for (d = 0; d < v.childrenIds.length; d++) {
          (y = l[v.childrenIds[d]]).collapsed = !1;
    ...
    var _ = [],
      ...
      I = [];
    for (d = 0; d < s.length; d++)
      OrgChart.manager._iterate(s[d], s[d], l, 0, _, w, k, S, "", m, I, t);
    if (
    ...
    for (d = 0; d < I.length; d++) {
      ...
      for (x = 0; x < C.children.length; x++) {
        (D = C.children[x]).isAssistant
          ? A.push(D.id)
          : -1 != D.tags.indexOf("right-partner")
          ? ((D.isPartner = 1), (D.children = []), E.push(D.id))
          : -1 != D.tags.indexOf("left-partner")
          ? ((D.isPartner = 2), (D.children = []), N.push(D.id))
          : -1 == D.tags.indexOf("partner") || M % 2
          ? -1 != D.tags.indexOf("partner") && M % 2
            ? ((D.isPartner = 2), (D.children = []), N.push(D.id), M++)
            : D.parentPartner
            ? (L[D.parentPartner.id] || (L[D.parentPartner.id] = []),
              L[D.parentPartner.id].push(D.id))
            : A.push(D.id)
          : ((D.isPartner = 1), (D.children = []), E.push(D.id), M++);
      }
      C.children = [];
      var F = [];
      for (x = 0; x < E.length; x++) {
        L[(D = l[E[x]]).id] ? C.children.push(D) : C.children.splice(0, 0, D);
        for (var H = 0; H < D.childrenIds.length; H++) F.push(D.childrenIds[H]);
      }
      var R = [];
      for (x = 0; x < N.length; x++) {
        L[(D = l[N[x]]).id] ? C.children.push(D) : C.children.splice(0, 0, D);
        for (H = 0; H < D.childrenIds.length; H++) R.push(D.childrenIds[H]);
      }
      ...
      for (x = N.length - 1; x >= 0; x--)
        if (L[N[x]])
          for (f = 0; f < L[N[x]].length; f++)
            C.children.push(l[L[N[x]][f]]),
              T++,
              -1 == P.indexOf(N[x]) && P.push(N[x]);
      ...
      for (x = 0; x < E.length; x++)
        if (L[E[x]])
          for (f = 0; f < L[E[x]].length; f++)
            C.children.push(l[L[E[x]][f]]),
              B++,
              -1 == U.indexOf(E[x]) && U.push(E[x]);
      ...
      (C.partnerSeparation =
        Math.max(P.length, U.length) * e.partnerChildrenSplitSeparation +
    ...
    for (var Y in w) {
      ...
      for (x = O.children.length - 1; x >= 0; x--) {
        (D = O.children[x]).isAssistant
          ? ((D.parent = null), O.children.splice(x, 1), X.splice(0, 0, D.id))
          : D.isPartner ||
            (D.parent &&
              S[D.parent.id] &&
              z &&
      ...
      if (X.length % 2) {
        ...
        OrgChart.manager._initDinamicNode($, q.lcn, !0),
          ...
          ($.h = q.h),
          (l[$.id] = $),
          X.splice(X.length - 1, 0, $.id);
      }
      var V = 1;
      for (x = X.length - 1; x >= 0; x--)
        if (x % 2 && x != X.length - 1) {
          var G = new OrgChart.node(
            O.id + "_split_assitant_" + V,
            O.pid,
            [],
            "split"
          );
          OrgChart.manager._initDinamicNode(G, O.lcn, !0),
            (l[G.id] = G),
            X.splice(x, 0, G.id),
            V++;
        ...
        if ((at = r[O.lcn ? O.lcn : "base"]).layout > 0 || et)
          if (
            ...
            for (x = 0; x < lt.length; x += 3) {
              W = null;
              0 == x && (W = O);
              (J = l[lt[x]]), (K = l[lt[x + 1]]), (Z = l[lt[x + 2]]);
              0 != x && (W = l[lt[x - 3]]),
                0 == x || K || (W = l[lt[x - 2]]),
                (J.parent = W),
                W.children.push(J),
    ...
    rt = { nodes: l, roots: s };
    return (
      OrgChart.events.publish("nodes-initialized", [t, rt]),
      { nodes: rt.nodes, roots: rt.roots, rootList: h }
    );
  }),
  ...
  (OrgChart.manager._getResponse = function (
    ...
    if (
      ...
      if (y - 2 * i.padding >= a - o)
        switch (((w = (a + o) / 2 - y / 2), i.orientation)) {
          case OrgChart.orientation.right:
          case OrgChart.orientation.right_top:
            w = (o - a) / 2 - y / 2;
        }
        ...
        switch (
          ((w = f.x - y / 2 + OrgChart.manager._getNodeWidth(f, i) / 2),
          i.orientation)
        ) {
          case OrgChart.orientation.right:
          case OrgChart.orientation.right_top:
    ...
    for (var E = 0; E < h.length; E++)
      OrgChart.manager._iterate2(h[E], g, i, s, d, c, m, p, r, b);
    return {
      animations: b,
      boundary: C,
      viewBox: s,
    ...
    link: function (t, e, r, i, a, n) {
      ...
      if (t.hasPartners) {
        ...
        for (var f = 0; f < t.children.length; f++) {
          (m = t.children[f]).parentPartner
            ? ((u.ppnodes[m.id] = m.parentPartner),
              u.ids.push(m.id),
              1 == m.parentPartner.isPartner
                ? (-1 == u.rightIds.indexOf(m.parentPartner.id) &&
                    u.rightIds.push(m.parentPartner.id),
                  (u.indexes[m.id] = u.rightIds.indexOf(m.parentPartner.id)),
                  u.firstRight || (u.firstRight = m))
                : 2 == m.parentPartner.isPartner &&
                  (-1 == u.leftIds.indexOf(m.parentPartner.id) &&
                    u.leftIds.push(m.parentPartner.id),
                  (u.indexes[m.id] = u.leftIds.indexOf(m.parentPartner.id)),
                  (u.lastLeft = m)))
            : m.isPartner ||
              ((u.lastLeft = m), u.firstRight || (u.firstRight = m));
        }
        (u.maxSidePartnersWithChildren = Math.max(
          u.leftIds.length,
          u.rightIds.length
        )),
          (c =
            0 == u.maxSidePartnersWithChildren
              ? e.config.minPartnerSeparation / 2
              : e.config.minPartnerSeparation / 2 +
                u.partnerChildrenSplitSeparation *
                  u.maxSidePartnersWithChildren +
                u.partnerChildrenSplitSeparation / 2);
      }
      for (f = 0; f < t.children.length; f++) {
        ...
        if (m.isChildOfPartner)
          switch (l.orientation) {
            case OrgChart.orientation.top:
            case OrgChart.orientation.top_left:
              var v = 1 == m.layout ? void 0 : C.minY - (C.minY - p.maxY) / 2;
              b = OrgChart.ui._linkTopToBottom(m.parentPartner, m, s, d, v);
              break;
            case OrgChart.orientation.bottom:
            case OrgChart.orientation.bottom_left:
              v = 1 == m.layout ? void 0 : C.maxY - (C.maxY - p.minY) / 2;
              b = OrgChart.ui._linkBottomToTop(m.parentPartner, m, s, d, v);
              break;
            case OrgChart.orientation.right:
            case OrgChart.orientation.right_top:
              v = 1 == m.layout ? void 0 : C.maxX - (C.maxX - p.minX) / 2;
              b = OrgChart.ui._linkRightToLeft(m.parentPartner, m, s, d, v);
              break;
            case OrgChart.orientation.left:
            case OrgChart.orientation.left_top:
              v = 1 == m.layout ? void 0 : C.minX - (C.minX - p.maxX) / 2;
              b = OrgChart.ui._linkLeftToRight(m.parentPartner, m, s, d, v);
          }
        else if (u && -1 != u.ids.indexOf(m.id))
          switch (l.orientation) {
            case OrgChart.orientation.top:
            case OrgChart.orientation.top_left:
          ...
          var x =
              m.isAssistant &&
              m.rightNeighbor &&
              m.rightNeighbor.isAssistant &&
              m.parent == m.rightNeighbor.parent,
            y =
              m.isAssistant &&
              m.leftNeighbor &&
          ...
          if ((x || m.layout > 1) && m.rightNeighbor && m.rightNeighbor.isSplit)
            switch (l.orientation) {
              ...
              case OrgChart.orientation.bottom:
              case OrgChart.orientation.bottom_left:
                b = OrgChart.ui._linkRightToLeft(m.rightNeighbor, m, s, d);
                break;
              case OrgChart.orientation.right:
              case OrgChart.orientation.right_top:
              case OrgChart.orientation.left:
            ...
            switch (l.orientation) {
              ...
              case OrgChart.orientation.bottom:
              case OrgChart.orientation.bottom_left:
                b = OrgChart.ui._linkLeftToRight(m.leftNeighbor, m, s, d);
                break;
              case OrgChart.orientation.right:
              case OrgChart.orientation.right_top:
              case OrgChart.orientation.left:
              case OrgChart.orientation.left_top:
                b = OrgChart.ui._linkTopToBottom(m.leftNeighbor, m, s, d);
            }
          else
            switch (l.orientation) {
              case OrgChart.orientation.top:
              case OrgChart.orientation.top_left:
                if (1 == m.isPartner)
                  b = OrgChart.ui._linkLeftToRight(t, m, s, c);
                else if (2 == m.isPartner)
                  b = OrgChart.ui._linkRightToLeft(t, m, s, c);
                else {
                  v = 1 == m.layout ? void 0 : C.minY - (C.minY - p.maxY) / 2;
                  b = OrgChart.ui._linkTopToBottom(t, m, s, d, v);
                }
                break;
              case OrgChart.orientation.bottom:
              case OrgChart.orientation.bottom_left:
                if (1 == m.isPartner)
                  ...
                  v = 1 == m.layout ? void 0 : C.maxY - (C.maxY - p.minY) / 2;
                  b = OrgChart.ui._linkBottomToTop(t, m, s, d, v);
                }
                break;
              case OrgChart.orientation.right:
              case OrgChart.orientation.right_top:
                if (1 == m.isPartner)
                  b = OrgChart.ui._linkTopToBottom(t, m, s, c);
                else if (2 == m.isPartner)
                  b = OrgChart.ui._linkBottomToTop(t, m, s, c);
                else {
                  v = 1 == m.layout ? void 0 : C.maxX - (C.maxX - p.minX) / 2;
                  b = OrgChart.ui._linkRightToLeft(t, m, s, d, v);
                }
                break;
              case OrgChart.orientation.left:
              case OrgChart.orientation.left_top:
                if (1 == m.isPartner)
                  ...
                  v = 1 == m.layout ? void 0 : C.minX - (C.minX - p.maxX) / 2;
                  b = OrgChart.ui._linkLeftToRight(t, m, s, d, v);
                }
            }
        }
        if (-1 != O.indexOf("{rounded}"))
          if (
            ...
            Math.abs(b.xa - b.xd) <= OrgChart.LINK_ROUNDED_CORNERS &&
            Math.abs(b.xa - b.xc) <= OrgChart.LINK_ROUNDED_CORNERS &&
            Math.abs(b.xa - b.xb) <= OrgChart.LINK_ROUNDED_CORNERS
          )
            O = O.replace(
              "{rounded}",
              "M" + b.xa + "," + b.ya + " L" + b.xa + "," + b.yd
            );
          else if (
            Math.abs(b.ya - b.yd) <= OrgChart.LINK_ROUNDED_CORNERS &&
            Math.abs(b.ya - b.yc) <= OrgChart.LINK_ROUNDED_CORNERS &&
            Math.abs(b.ya - b.yb) <= OrgChart.LINK_ROUNDED_CORNERS
          )
            O = O.replace(
              "{rounded}",
              "M" + b.xa + "," + b.ya + " L" + b.xd + "," + b.ya
            );
          else {
            var _ = OrgChart.ui._roundedEdge(
                b.xa,
                b.ya,
                b.xb,
                b.yb,
        ...
        h.push(
          OrgChart.linkOpenTag
            .replace("{id}", t.id)
            .replace("{class}", "link " + m.tags.join(" "))
            .replace("{child-id}", m.id)
        );
        var k = { node: t, cnode: m, p: b, html: O, action: n };
        ...
        for (var I in e.config.linkBinding) {
          ...
          if (E) {
            ...
            (k.value = N),
              (k.element = s[I]),
              (k.name = A),
              !1 !== OrgChart.events.publish("label", [e, k]) &&
                (OrgChart.isNEU(k.value) ||
                  OrgChart.isNEU(k.element) ||
  ...
  (OrgChart.wrapText = function (t, e) {
    ...
    if (-1 != c.indexOf("multiline")) {
      ...
      for (var x = 1, y = 1; y < C.length; y++) {
        ...
        if (
          ((O.firstChild.data += " " + C[y]), O.getComputedTextLength() > d)
        ) {
          if (
            ((O.firstChild.data = O.firstChild.data.slice(0, _)),
            x++,
            a && x > a)
          ) {
          ...
          (O = document.createElementNS(g, "tspan")).setAttributeNS(
            null,
            "x",
            l
          ),
    ...
    if (
      ...
      !(function (t, r, i) {
        ...
        function n() {
          ...
          Math.ceil(e.bar.scrollLeft) == Math.ceil(e.pos)
            ? (a = !1)
            : ((e.bar.scrollLeft += t), o(n));
        }
        t.addEventListener(
          "wheel",
          function (t) {
            ...
            if (e.config.mouseScrool == OrgChart.action.xScroll)
              (i = t.deltaX || t.wheelDeltaX) ||
                (i = t.deltaY || t.wheelDeltaY);
            else if (
    ...
    if (
      ...
      !(function (t, r, i) {
        ...
        function n() {
          ...
          Math.ceil(e.bar.scrollTop) == Math.ceil(e.pos)
            ? (a = !1)
            : ((e.bar.scrollTop += t), o(n));
        }
        t.addEventListener(
          "wheel",
          function (t) {
  ...
  (OrgChart.prototype._clink = function (t, e) {
    for (var r, i, a, n, o, l = "", s = 0; s < this.config.clinks.length; s++) {
      ...
      if (
        d &&
        -1 != e.res.visibleNodeIds.indexOf(d.id) &&
        c &&
        -1 != e.res.visibleNodeIds.indexOf(c.id)
      ) {
        var g = d.x,
          p = d.y,
          u = c.x,
  ...
  (OrgChart._search.searchAndComputeScore = function (t, e, r, i) {
    ...
    for (p = n.length - 1; p >= 0; p--)
      O = (O = O.insert(n[p].start + n[p].length, "</mark>")).insert(
        n[p].start,
        "<mark>"
      );
  ...
  (OrgChart.prototype.onDrop = function (t) {
    return this.on("drop", function (e, r, i, a) {
      var n = { dragId: r, dropId: i, dragNodeElement: a };
      return t.call(e, n);
    });
  }),
  ...
  (OrgChart.filterUI.prototype.show = function (t) {
    var e = this.instance.element.querySelector(
      '[data-filter-field="' + t + '"]'
    );
    e && e.click();
  }),
  ...
  (OrgChart.filterUI.prototype.update = function () {
    if (this.instance.config.filterBy) {
      ...
      if ("all" == this.instance.config.filterBy)
        ...
        for (e = 0; e < this.instance.config.filterBy.length; e++)
          t[this.instance.config.filterBy[e]] = {};
      ...
      for (var a in t) {
        ...
        for (e = 0; e < this.instance.config.nodes.length; e++) {
          ...
          null != o && (n[o] || (n[o] = { checked: !0, text: o }));
        }
      }
      if (null != this.filterBy)
        for (var l in t)
          if (this.filterBy[l])
            for (var s in t[l])
              this.filterBy[l][s] && (t[l][s] = this.filterBy[l][s]);
      this.filterBy = t;
      var h = this,
        d = this.instance.element.querySelector("[data-filter]");
      d && d.parentNode.removeChild(d),
        (d = document.createElement("div")).setAttribute("data-filter", ""),
        (d.style.position = "absolute"),
        d.setAttribute("class", "boc-filter"),
        (d.style.top = this.instance.config.padding + "px"),
        (d.style.left = this.instance.config.padding + "px");
      var c = "";
      for (var l in this.filterBy)
        c += `<div data-filter-field="${l}">${l}</div>`;
      (d.innerHTML = `<div>${c}</div>`),
          ...
          if (
            ...
            for (
              var e = t.target.getAttribute("data-filter-field"),
                r = h.instance.element.querySelectorAll("[data-filter-menu]"),
                i = 0;
              i < r.length;
              i++
            )
              r[i].style.display = "none";
            var a = h.instance.element.querySelectorAll(
            ...
            if (!o) {
              ...
              for (i = 0; i < g.length; i++)
                g[i].addEventListener("change", function (t) {
                  for (
                    var e = t.target;
                    ...
                    if (t.target.hasAttribute("data-all")) {
                      for (
                        ...
                        if (i[a] != t.target)
                          ...
                          h.filterBy[r]))
                            h.filterBy[r][n].checked = t.target.checked;
                    } else
                      null != h.filterBy[r][this.name] &&
                        (h.filterBy[r][this.name].checked = this.checked);
                    h.instance.draw();
                  }
                });
            }
        ...
        this.instance.element.appendChild(d);
    }
  }),
  void 0 === OrgChart && (OrgChart = {}),
